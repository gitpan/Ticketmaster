...
The module is developed for the programms which need to calculate change correctly.
For example, a ticket machine for people to buy bus tickets needs to generates change.
...
Optional method, is used for increasing coins in store.
